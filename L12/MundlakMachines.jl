...
begin
	...
	chain_fixed = sample(fixed_effects_model, NUTS(), MCMCThreads(), 1000, 3)
...
begin
	...
	chain_naive = sample(naive_model, NUTS(), MCMCThreads(), 1000, 3)
...
begin
	...
	chain_partial_pool = sample(partial_pool_model, NUTS(), MCMCThreads(), 1000, 3)
...
begin
	...
	chain_mundlak = sample(mundlak_model, NUTS(), MCMCThreads(), 1000, 3)
...
begin
	...
	chain_flb = sample(flb_model, NUTS(), 1000)
	describe(chain_flb)
end
